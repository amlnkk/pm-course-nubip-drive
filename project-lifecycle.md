...
> **Проєкт:** Веб-застосунок для управління завданнями команди (Task Tracker)
> *(Приклад заповнення — замініть на дані свого проєкту з Лабораторної роботи №2)*
...
## Примітка щодо README.md

Після створення цього документа необхідно додати до `README.md` репозиторію команди посилання виду:
